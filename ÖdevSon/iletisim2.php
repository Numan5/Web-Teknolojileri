                                ...
                                <div class="row">
                                    ...
                                    echo '
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="name" name="name" value="' . $_POST["name"] . '" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" placeholder="Email" id="email" class="form-control" name="email" value="' . $_POST["email"] . '" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" placeholder="Konu" id="msg_subject" class="form-control" required  value="' . $_POST["msg_subject"] . '"disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <textarea class="form-control" id="message" placeholder="Mesajınız" rows="5" data-error="Write your message" required disabled>' . $_POST["message"] . '</textarea>
                                        </div>
                                        </div>
                                        ';
                                    ?>
